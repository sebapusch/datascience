...
From those confusion matrices, we can see that the model is relatively accurate when it comes to predicting correct answers, however the model really struggles with properly predicting incorrect answers.
